...
<!-- Mirrored from demo.themefisher.com/themefisher/bingo/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Mar 2020 20:10:14 GMT -->
<head>
...
<!-- Mobile Specific Meta
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" type="image/x-icon" href="<?=base_url('assets/img/favicon.html')?>" />
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<a href="<?=base_url('Home')?>" class="btn btn-main mt-20">Go Home</a>
				</div>
			</div>
		</div>
	</section>
