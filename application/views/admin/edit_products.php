      ...
      <div class="col-md-8 offset-md-2 col-sm-12  ">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <?php
            foreach ($productsdata as $cont) 
            {
              ?>
            <form class="form-horizontal form-label-left" id="product_form">
              <input type="hidden" name="product_id" value="<?=$cont->product_id?>" class="form-control">
              <input type="hidden" name="old_image" value="<?=$cont->product_image?>" class="form-control">
              <input type="hidden" name="old_icon" value="<?=$cont->icon?>" class="form-control">
               <div class="form-group row">
                ...
                <div class="col-md-9 col-sm-9 col-xs-9">
                  <img class="img-responsive" src="<?=base_url('assets/admin/uploads/Product/Icons/').$cont->icon?>" style="height:50px">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9 col-sm-9 col-xs-9">
                  <input type="text" name="products" value="<?=$cont->products?>" class="form-control">
                </div>
              </div>
                 <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9 col-sm-9 col-xs-9">
                  <img class="img-responsive" src="<?=base_url('assets/admin/uploads/Product/').$cont->product_image?>" style="height:50px">
                </div>
              </div>
              <div class="form-group row">
...
$("#product_form").submit(function(e){
        ...
        $.ajax({
            url:"<?=base_url('admin/Products/updatedata')?>",
             type:"post",
             data:formData,
             contentType:false,
             processData:false,
